...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      debugShowCheckedModeBanner: false, //untuk mengilangkan DEBUG
...
class _CalculatorState extends State<Calculator> {
  ...
  Widget build(BuildContext context){//fungsi build digunakan untuk membuat tampilan utama
    ...
    body:  Column(
      crossAxisAlignment: CrossAxisAlignment.stretch, //tanpa CrossAxisAligment.strech, tombol tersebut akan memiliki lebar sesuai dengan ukuran teksnya masing masing atau pengaturan default widget tombol
      children: <Widget>[
        Expanded(
          child: Container(
